/* * Biblioteca para gerenciar categorias de serviços
 * Funções para ler, criar, atualizar e excluir categorias
 * Utiliza um arquivo JSON para persistência de dados
 * */
